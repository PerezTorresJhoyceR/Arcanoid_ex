...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABrick_Statics::NewProp_SM_Brick_MetaData[] = {
		{ "Category", "Brick" },
		{ "Comment", "//verse en cualquier lado y que los blueprit de lectura \n// para darle una malla\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Brick.h" },
		{ "ToolTip", "verse en cualquier lado y que los blueprit de lectura\n para darle una malla" },
	};
#endif
	...
	IMPLEMENT_CLASS(ABrick, 1050428048);
